...
client_61a8ad3366a84b259305286667ebbe16 = ibm_boto3.client(service_name='s3',
    ibm_api_key_id='vCwKPBPiXpB_wMz1nGidrst61cxaRF8yg9xG24c8SMUT',
...
def Test_data_preperation(df, df1):
    ...
    for i in range(120):
        y_prediction = client.deployments.score(scoring_endpoint,test_X)
